...
function oxTopicPrompt(type){
  const directions={
    ...
    blog:'일반 독자를 위한 Science Magazine 스타일의 대중 과학 소재를 제안한다. 천문학·우주, 물리, 생명과학, 지구과학·기후, 공학, 미래기술, 과학사, 흥미로운 자연현상 범위에서 검증 가능한 주제만 다루고 불확실한 사실을 지어내지 않는다.'
  };
...
5개는 서로 다른 과학 분야에서 고르고, 최소 1개는 천문학·우주 소재로 한다. 일반인이 제목만 보고도 "왜 그럴까?", "어떻게 가능할까?"라는 궁금증을 느낄 현상·발견·원리·실험·기술을 우선한다. 논문 제목을 옮긴 듯한 전문 요약형 소재보다 쉽고 흥미로운 과학 잡지형 관점을 사용한다. 블랙홀, 제임스 웹 우주망원경(JWST), 화성처럼 자주 쓰이는 대표 소재에 반복적으로 의존하지 말고, 같은 천체·현상·기술·핵심 질문을 후보 안에서 중복하지 않는다. 신뢰할 수 있는 기관·연구·자료와 구체적인 검색 키워드를 확보하기 쉬운 주제를 우선한다.`:'';
