...
인물을 사용하는 경우 첨부된 Character Master의 여성은 '보아(VOA)'다. 반드시 그 참조 인물의 동일한 정체성으로 생성한다. 얼굴형, 눈·코·입 비율, 피부톤, 연령대, 기본 머리색과 전체 인상은 바꾸지 않는다. 의상, 표정, 포즈, 헤어 연출, 앵글과 배경은 장면에 맞게 자유롭게 바꿀 수 있다. 다른 여성으로 재해석하거나 얼굴을 랜덤화하지 않는다. 과도한 노출이나 성적 연출은 금지.
