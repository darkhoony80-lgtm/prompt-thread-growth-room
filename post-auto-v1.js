...
function addVideoMergeFiles(i,fileList){
 ...
 try{
  ...
  videoMergeDrafts.set(masterKey(i),{files,previewUrls,encoding:false,status:'영상을 재생해 확인하고 순서를 정한 뒤 인코딩을 시작하세요.'});renderVideoMergeDraft(i);
